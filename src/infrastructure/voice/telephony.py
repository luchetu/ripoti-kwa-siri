"""LiveKit SIP telephony bridge configuration."""
...
def serialize_dispatch_rule_request(r: DispatchRuleCreateRequest) -> dict[str, object]:
    return r.model_dump(by_alias=True, exclude_none=True)


def serialize_inbound_trunk_request(r: InboundTrunkCreateRequest) -> dict[str, object]:
    return r.model_dump(by_alias=True, exclude_none=True)
